 ...
 */
package com.abubusoft.testing.compile;
...
import com.abubusoft.testing.compile.CompilationFailureException;
import com.abubusoft.testing.compile.CompileTester;
import com.abubusoft.testing.compile.JavaFileObjects;
import com.abubusoft.testing.compile.JavaSourceSubjectFactory;
import com.abubusoft.testing.compile.JavaSourcesSubjectFactory;
...
public class JavaSourcesSubjectFactoryTest {
  ...
  public void generatesFileNamed() {
    assertAbout(javaSource())
        ...
        .compilesWithoutError()
        .and()
        .generatesFileNamed(CLASS_OUTPUT, "com.abubusoft.testing.compile", "Foo")
  ...
  public void generatesFileNamed_failOnFileExistence() {
    try {
      VERIFY.about(javaSource())
          ...
          .compilesWithoutError()
          .and()
          .generatesFileNamed(CLASS_OUTPUT, "com.abubusoft.testing.compile", "Bogus")
          .withContents(ByteSource.wrap("Bar".getBytes(UTF_8)));
      fail();
    } catch (VerificationException expected) {
      assertThat(expected.getMessage())
